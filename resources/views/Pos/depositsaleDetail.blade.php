    ...
    <div class="mt-3 rounded-lg p-5">
        ...
        <div class="flex justify-between">
            <div class=" flex-col flex ">
                ...
                <span>{{ $DepositSaleDetail->cus_name }}</span>
                <span>{{ $DepositSaleDetail->phone }}</span>
                <span>{{ $DepositSaleDetail->address }}</span>
            </div>
            <div class=" flex-col flex">
                ...
                <div>
                    ...
                    <span>{{ $DepositSaleDetail->date_only }}</span>
                </div>
            </div>
        ...
        <div class="mt-5">
            <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
                ...
                <tbody>
                    @forelse ($DepositSaleProducts as $item)
                        <tr
        ...
        <div class=" mt-5 flex  flex-col justify-end items-end">
            <div class="flex mt-5 space-x-3  ">
                ...
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->discount }}Ks</span>
            </div>
            <div class="flex mt-5 space-x-3 ">
                <span class=" font-semibold text-lg">Grand Total : </span>
                <input id="total" type="text" hidden value="{{ $DepositSaleDetail->grand_total }}">
                <span class=" font-semibold text-lg " id="gtotal">Ks</span>
            </div>
            <div class="flex mt-5 space-x-3  ">
                <span class=" font-semibold text-lg">Deposit Paid : </span>
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->deposit }} Ks</span>
            </div>
            <div class="flex mt-5 space-x-3 ">
                <span class=" font-semibold text-lg">Credit Balance : </span>
                <span class=" font-semibold text-lg">{{ $DepositSaleDetail->credit }} Ks</span>
            </div>
        </div>
    </div>
