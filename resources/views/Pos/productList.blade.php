...
@section('body')
    <p class=" text-2xl">Product List</p>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        <div class="pb-4 bg-white dark:bg-gray-900">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="table-search" name="search_product"
            ...
            <tbody>
                @forelse ($productData as $product)
                    <tr
                        ...
                        <th scope="row"
                            class="px-6 text py-4 flex items-center space-x-2 font-medium text-gray-900 whitespace-normal dark:text-white">
        ...
        <p class=" text-2xl mt-8">Charges and Fees List</p>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
            ...
            <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
                ...
                <tbody>
                    @forelse ($chargesandfees as $product)
                        <tr
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <div class="p-5">
                {{ $chargesandfees->links('pagination::tailwind') }}
            </div>
            @if (session('success'))
                <script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                sessionStorage.setItem("productamt", productTotal);
            });
        </script>
