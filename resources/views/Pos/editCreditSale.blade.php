...
@section('title', 'Edit CashSale');
@section('body')
    <p class=" text-2xl">Edit Credit Sale</p>
    <form action="/creditsale/{{ $CashsaleData->id }}" method="post">
        @csrf
        @method('put')
        <div class="mt-3 rounded-lg shadow-lg p-5">
            ...
            <div class="flex w-full justify-around items-center space-x-3 p-5">
                ...
                <div class="mb-6 w-1/2">
                    <label for="paid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Payment
                    </label>
            ...
            <div class="card-body">
                ...
                <div class="mt-5 flex items-center justify-end  ">
                    ...
                    <input type="number" readonly class="rounded-lg font-semibold text-lg w-28 border-transparent"
                        name="grandtotal" value="{{ $CashsaleData->grand_total }}" id="gtotal">
                </div>
                <div class=" mt-28 mb-5 flex flex-col">
                    <label for="description">Remarks</label>
                    <textarea name="remark" id="" cols="100" rows="2">{{ $CashsaleData->remark }}</textarea>
                </div>
