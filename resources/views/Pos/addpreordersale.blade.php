...
<body>
    ...
    <nav
        class=" bg-blue-700 p-2 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
       ...
       <a href="/customer/create"> <button class="px-3 py-2 bg-blue-600 rounded-lg text-white">+ Add Customer</button></a>
        ...
        <form action="/preordersale" method="post">
            ...
            <div class="mt-3 rounded-lg shadow-lg p-5">
                ...
                <div class="flex space-x-3 p-3 w-8/12 justify-items-center items-center">
                    <div class="mb-6 w-full">
