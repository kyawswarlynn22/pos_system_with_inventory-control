...
@section('body')
    ...
    <div class="mt-5">Product Purchase List(Received)</div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        ...
        <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
            ...
            <tbody>
                @forelse ($purchaseList as $item)
                    ...
                    @empty
                        <Span class=" text-red-500 font-bold">No Purchase Producs</Span>
                @endforelse
        ...
        <div>Product Purchase List(Pending)</div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5">
        <div class="pb-4 bg-white dark:bg-gray-900">
            <label for="table-search" class="sr-only">Search</label>
            <div class="relative mt-1">
        ...
        <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
            ...
            <tbody>
                @forelse ($purchaseListPending as $item)
                    <tr
                        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <div class="p-5">
            {{ $purchaseListPending->links('pagination::tailwind') }}
        </div>
        <div class=" mt-10 mb-5 font-medium ">Product Purchase List(Received)</div>
        <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
            <thead class="text-xs text-white uppercase bg-blue-400  dark:bg-gray-700 dark:text-gray-400">
                <tr>
    ...
    <div class=" mt-10 mb-5 font-medium ">Product Purchase List(Pending)</div>
    <table class="w-full text-sm text-left text-gray-500 rounded-lg dark:text-gray-400">
        <thead class="text-xs text-white uppercase bg-blue-400  dark:bg-gray-700 dark:text-gray-400">
            <tr>
        ...
        <tbody>
            @forelse ($purchaseDataPending as $item)
                <tr
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
    ...
    <div class="p-5">
        {{ $purchaseDataPending->links('pagination::tailwind') }}
    </div>
</div>
